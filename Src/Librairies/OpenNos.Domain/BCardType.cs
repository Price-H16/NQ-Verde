namespace OpenNos.Domain
{
    ...
    {
<<<<<<< HEAD:Src/ChickenApi/ChickenAPI.Enums/Game/BCard/BCard_Additional.cs
=======
        #region Enums
        ...
        public enum CardType : byte
        {
            ...
            IncreaseDamageVsMonsterInMap = 101,
            IncreaseSlPoint = 102,
...
>>>>>>> parent of d7ef289... Bcard Cleaning:Src/Librairies/OpenNos.Domain/BCardType.cs
        ...
        {
            ReputationIncrease = 11,
            ReputationDerease = 12,
            ExpHeroIncrease = 21,
            ExpHeroDecrease = 22,
            GetRandomItem = 31,
            RemoveBuffEnemi = 41,
            SpawnDragSqueBuff1 = 51,
            SpawnDragSqueBuff2 = 52
        }
        ...
        public enum IncreaseDamageVsChar : byte
        {
            IncreaseCACDamage = 21,
            IncreaseRangedDamage = 31,
            IncreaseMagicalDamage = 41
        }
        ...
        public enum ScelledLodDamage : byte
        {
            ReduceDamageByPourcentVsFireWhenDefending = 11,
            SealedAndLodMonsterDamage = 21,
            DamageIncreaseInRBBAndSpeed = 31,
            SealedAndAct4MonsterDamage = 41
        }
