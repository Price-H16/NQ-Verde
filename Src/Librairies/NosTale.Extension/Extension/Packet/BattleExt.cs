            ...
            bool isPvp = false)
        {
            ...
            if (skills != null)
            {
                ...
                if (ski != null)
                {
                    ...
                    if (Session.Character.GetBuff(BCardType.CardType.HealingBurningAndCasting, (byte)AdditionalTypes.HealingBurningAndCasting.HPDecreasedByConsumingMP)[0] is int HPDecreasedByConsumingMP)
                    {
