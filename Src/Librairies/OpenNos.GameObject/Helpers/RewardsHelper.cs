...
namespace OpenNos.GameObject.Helpers
{
    public class RewardsHelper
    {
...

        {
            ...
            if (characterLevel <= 90) return (int)(CharacterHelper.XPData[characterLevel] / 80);

            if (characterLevel <= 93) return (int)(CharacterHelper.XPData[characterLevel] / 100);

            if (characterLevel <= 99) return (int)(CharacterHelper.XPData[characterLevel] / 1000);
