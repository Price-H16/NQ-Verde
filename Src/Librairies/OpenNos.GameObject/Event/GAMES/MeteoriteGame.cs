    ...
    public static class MeteoriteGame
    {
        ...
        public class MeteoriteGameThread
        {
            ...
            private void runRound(int number)
            {
                ...
                // Your dropped reward
                _map.DropItems(generateDrop(_map.Map, 1046, 20, 500 * ((number + 1) > 10 ? 10 : (number + 1))).ToList());
                _map.DropItems(generateDrop(_map.Map, 1030, 10, 1 * ((number + 1) > 10 ? 10 : (number + 1))).ToList());
                _map.DropItems(generateDrop(_map.Map, 2282, 10, 1 * ((number + 1) > 10 ? 10 : (number + 1))).ToList());
