    ...
    public class CaligorRaidThread
    {
        ...
        public void Run()
        {
            ...
            CaligorRaid.CaligorMapInstance =
                ServerManager.GenerateMapInstance(154, MapInstanceType.CaligorInstance, new InstanceBag());
            CaligorRaid.UnknownLandMapInstance =
                ServerManager.GetMapInstance(ServerManager.GetBaseMapInstanceIdByMapId(153));
            ...
            var caligor = CaligorRaid.CaligorMapInstance.Monsters.Find(s => s.Monster.NpcMonsterVNum == 2305);
            ...
            //if (!caligor.IsAlive)
            //{
            //    // PORTAL TO FERNON (1 HOUR)
            //    CaligorRaid.UnknownLandMapInstance.CreatePortal(new Portal
            //    {
            //        Type = (byte)PortalType.Open,
            //        SourceMapId = 153,
            //        SourceX = 89,
            //        SourceY = 10,
        ...
        {
            var maxHP = ServerManager.GetNpcMonster(2305).MaxHP;
