...
{
    public class FInsPacketHandler : IPacketHandler
    {
        #region Instantiation

        public FInsPacketHandler(ClientSession session)
        {
            Session = session;
        }
                                        ...
                                        case 34:
                                            ...
                                            ServerManager.Instance.Broadcast(
                                                UserInterfaceHelper.GenerateMsg(
                                                    string.Format(
                                                        Language.Instance.GetMessageFromKey("MARRIAGE_ACCEPT_SHOUT"),
                                                        Session.Character.Name, otherSession.Character.Name), 0));
                                            break;
