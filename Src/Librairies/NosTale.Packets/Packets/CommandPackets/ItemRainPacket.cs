...
{
    [PacketHeader("$ItemRain", PassNonParseablePacket = true, Authorities = new[] {AuthorityType.Administrator})]
    public class ItemRainPacket : PacketDefinition
    {
        ...
        [PacketIndex(2)] public int Count { get; set; }

        [PacketIndex(3)] public int Time { get; set; }
