...
namespace OpenNos.Master.Library.Interface
{
    ...
    public interface IAdminToolService
    {
        ...
        void SendItem(string senderName, long receivingCharacterId, short vnum, short amount = 1, byte rare = 0,
            byte Upgrade = 0, bool isNosmall = false);
        ...
        /// <param name="Upgrade">Upgrade of the Item</param>
        /// <param name="isNosmall"></param>
        void SendItemToMap(Guid channelId, string senderName, Guid mapInstanceId, short vnum, short amount = 1,
            byte rare = 0, byte Upgrade = 0, bool isNosmall = false);
        ...
        void SummonNPCMonster(Guid channelId, short npcMonsterVnum, short amount, Guid mapInstanceId, short mapX = 0,
            short mapY = 0);
