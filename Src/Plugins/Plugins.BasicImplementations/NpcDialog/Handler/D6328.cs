...
{
    public class D6328 : INpcDialogAsyncHandler
    {
        public long HandledId => 6328;
        ...
        public async Task Execute(ClientSession Session, NpcDialogEvent packet)
        {
           ...
           else
           {
               ...
               Session.Character.GiftAdd(5065, 10);
               Session.Character.Inventory.RemoveItemAmount(1369, 200);
           }
        }
    }
}