    ...
    public class MinHitAlgorithm : ICharacterStatAlgorithm
    {
        ...
        public void Initialize()
        {
            ...
            for (var i = 0; i < MAX_LEVEL; i++)
            {
                ...
                _stats[(int) CharacterClassType.Swordsman, i] = 2 * i + 5; // approx Numbers n such that 10n+9 is prime.
                _stats[(int) CharacterClassType.Magician, i] =
                ...
                _stats[(int) CharacterClassType.MartialArtist, i] = 9 + i * 3; // approx
            }
        }
