...
namespace ChickenAPI.DAL
{
    ...
    public interface IMapper<TEntity, TDto>
    {
        ...
        /// <summary>
        /// Maps input properties into output Should be used only when output has a value
        /// </summary>
        ...
        /// <summary>
        /// Maps the entity to its <typeparam name="TDto"></typeparam> from the given <typeparam name="TEntity"></typeparam>
        /// </summary>
        /// <param name="input"></param>
        /// <param name="output"></param>
        ...
        /// <summary>
        /// Maps all the given <typeparam name="TEntity"></typeparam> to their corresponding
        /// <typeparam name="TDto"></typeparam>
        /// </summary>
        /// <param name="input"></param>
        /// <param name="output"></param>
        ...
        /// <summary>
        /// Maps all the given <typeparam name="TDto"></typeparam> to their corresponding <typeparam name="TEntity"></typeparam>
        /// </summary>
        /// <param name="input"></param>
        /// <param name="output"></param>
        /// <returns>false if the mapping failed</returns>
        ...
        /// <summary>
        /// Maps the given Dto to its <typeparam name="TEntity">entity</typeparam>
        /// </summary>
        /// <param name="input"></param>
        /// <param name="output"></param>
        /// <returns>false if the mapping failed</returns>
